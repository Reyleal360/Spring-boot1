...
/**
 * DTO (Data Transfer Object) para representar un Venue (lugar del evento).
 * 
...
public class VenueDTO {
    ...
    @Schema(description = "Dirección completa del venue", 
            example = "Calle 72 # 46-31, Barranquilla, Atlántico", 
            required = true)
    ...
    @Schema(description = "Descripción adicional del venue", 
            example = "Estadio principal de Barranquilla, sede de eventos deportivos y conciertos")
    ...
    @Schema(description = "Estado del venue", example = "ACTIVE", allowableValues = {"ACTIVE", "INACTIVE", "MAINTENANCE"})
